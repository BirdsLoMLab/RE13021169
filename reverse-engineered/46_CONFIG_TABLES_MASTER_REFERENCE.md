...
**A guide to the game's 908 configuration tables: how they are stored, how to decode and read them, how they join together, and the combat & progression formulas they drive.**
...
The LOM client ships **one binary blob** that decompresses into **908 config tables** (≈4,800 fields). Everything the game "knows" — every unit's stats, every skill coefficient, every soul's essence cost, every shop price, every language string — lives in those tables. The game engine is mostly generic; the *content* is data.
...
Part 7 is the **complete catalog** of all 908 tables grouped by system, with row counts, primary keys, and field shapes.
...
It is a **FilePack v5** container holding all 908 tables (including the localization tables). At runtime the client loads it via `BaseConfig.loadBufferData()`; individual tables are also loadable as plain JSON via `BaseConfig.loadData()` in dev builds.
...
Every table has a schema, extracted to `data/schemas/ConfigXxx.json` (700 of 908 tables have one; the rest are trivial or language packs). A schema tells you the field order and which fields are obfuscated:
...
All 908 tables, grouped by system. Numbered variants (`Chapter1`–`Chapter100`, `MainUnit1`–`MainUnit100`) are per-chapter stage / enemy tables that reuse their base `Chapter` / `MainUnit` schema, shown here with those inherited fields. Columns: **Rows** (record count), **Key** (`mainKey`), **Fields** (first fields, `…` if more). Definition tables pair with their `*_level` progression tables; `attr`/`expend` arrays follow the conventions in Part 2.
...
| `MainUnit1` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit10` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit100` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit11` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit12` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit13` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit14` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit15` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit16` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit17` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit18` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit19` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit2` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit20` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit21` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit22` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit23` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit24` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit25` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit26` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit27` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit28` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit29` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit3` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit30` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit31` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit32` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit33` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit34` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit35` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit36` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit37` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit38` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit39` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit4` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit40` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit41` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit42` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit43` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit44` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit45` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit46` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit47` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit48` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit49` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit5` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit50` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit51` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit52` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit53` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit54` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit55` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit56` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit57` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit58` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit59` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit6` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit60` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit61` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit62` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit63` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit64` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit65` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit66` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit67` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit68` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit69` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit7` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit70` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit71` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit72` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit73` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit74` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit75` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit76` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit77` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit78` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit79` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit8` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit80` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit81` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit82` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit83` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit84` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit85` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit86` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit87` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit88` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit89` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit9` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit90` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit91` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit92` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit93` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit94` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit95` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit96` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit97` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit98` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
| `MainUnit99` | 660 | id | id, model, type, hatred_type, ai, att_skill, skills, … |
...
| `Chapter1` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter10` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter100` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter11` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter12` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter13` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter14` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter15` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter16` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter17` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter18` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter19` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter2` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter20` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter21` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter22` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter23` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter24` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter25` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter26` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter27` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter28` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter29` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter3` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter30` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter31` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter32` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter33` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter34` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter35` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter36` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter37` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter38` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter39` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter4` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter40` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter41` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter42` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter43` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter44` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter45` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter46` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter47` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter48` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter49` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter5` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter50` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter51` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter52` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter53` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter54` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter55` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter56` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter57` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter58` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter59` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter6` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter60` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter61` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter62` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter63` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter64` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter65` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter66` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter67` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter68` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter69` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter7` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter70` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter71` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter72` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter73` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter74` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter75` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter76` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter77` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter78` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter79` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter8` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter80` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter81` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter82` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter83` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter84` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter85` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter86` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter87` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter88` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter89` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter9` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter90` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter91` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter92` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter93` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter94` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter95` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter96` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter97` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter98` | 500 | id | id, index, type, level, power, map, chapter, … |
| `Chapter99` | 500 | id | id, index, type, level, power, map, chapter, … |
...
| `Language_ui_id` | 2133 | id | id, text |
| `Language_ui_it` | 6237 | id | id, text |
| `Language_ui_pt` | 6237 | id | id, text |
| `Language_ui_ru` | 6236 | id | id, text |
| `Language_ui_th` | 2133 | id | id, text |
| `Language_ui_tr` | 6237 | id | id, text |
| `Language_ui_tw` | 2133 | id | id, text |
| `Language_ui_vn` | 2134 | id | id, text |
| `Language_vn` | 13172 | id | id, text |
